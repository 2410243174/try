 ...
 * 请提前取关至少250个商店确保京东试用脚本正常运行
  cron "0 9 * * * task /jd/own/2410243174_try/jd_try.js --grouping 1,2@3,4@9,11"
...
let args_xh = {
     ...
     * 默认为0
     * */
    jdPrice: process.env.JD_TRY_PRICE * 1 || 90,
    /*
     * 获取试用商品类型，默认为1
...
!(async() => {
    ...
    if(process.env.JD_TRY && process.env.JD_TRY === 'truee'){
        await requireConfig()
        if(!$.cookiesArr[0]){
